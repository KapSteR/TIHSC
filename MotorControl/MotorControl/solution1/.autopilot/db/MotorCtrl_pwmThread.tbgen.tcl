...
set C_modelArgList { 
	...
	{ MotorCtrl_pwmCount_V int 10 regular {pointer 2}  }
	{ MotorCtrl_DIR int 1 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "pwmR", "interface" : "wire", "bitwidth" : 10,"bitSlice":[{"low":0,"up":9,"cElement": [{"cName": "MotorCtrl.pwmR.m_if.Val.V","cData": "uint10","bit_use": { "low": 0,"up": 9},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "MotorCtrl_DIR", "interface" : "wire", "bitwidth" : 1,"bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "MotorCtrl.DIR","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ pwmL sc_in sc_lv 10 signal 1 } 
	{ Direction sc_in sc_logic 1 signal 2 } 
	{ EN1 sc_out sc_logic 1 signal 3 } 
	{ EN1_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ EN2 sc_out sc_logic 1 signal 4 } 
	{ EN2_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ DIR1 sc_out sc_logic 1 signal 5 } 
	{ DIR1_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ DIR2 sc_out sc_logic 1 signal 6 } 
	{ DIR2_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ MotorCtrl_pwmCount_V_i sc_in sc_lv 10 signal 7 } 
	{ MotorCtrl_pwmCount_V_o sc_out sc_lv 10 signal 7 } 
	{ MotorCtrl_pwmCount_V_o_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ MotorCtrl_DIR sc_out sc_logic 1 signal 8 } 
	{ MotorCtrl_DIR_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ MotorCtrl_pwmClock_V sc_in sc_lv 1 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "MotorCtrl_pwmCount_V_i", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "MotorCtrl_pwmCount_V", "role": "i" }} , 
 	{ "name": "MotorCtrl_pwmCount_V_o", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "MotorCtrl_pwmCount_V", "role": "o" }} , 
 	{ "name": "MotorCtrl_pwmCount_V_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "MotorCtrl_pwmCount_V", "role": "o_ap_vld" }} , 
 	{ "name": "MotorCtrl_DIR", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "MotorCtrl_DIR", "role": "default" }} , 
 	{ "name": "MotorCtrl_DIR_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "MotorCtrl_DIR", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	MotorCtrl_pwmCount_V { ap_ovld {  { MotorCtrl_pwmCount_V_i in_data 0 10 }  { MotorCtrl_pwmCount_V_o out_data 1 10 }  { MotorCtrl_pwmCount_V_o_ap_vld out_vld 1 1 } } }
	MotorCtrl_DIR { ap_vld {  { MotorCtrl_DIR out_data 1 1 }  { MotorCtrl_DIR_ap_vld out_vld 1 1 } } }
