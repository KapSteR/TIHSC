...
\label{sec:hardware}
	...
	\label{sub:sensor}
		...
		\label{ssub:sensor_communication_protocol}
			The LDS transmits data via 3.3V RS-232 at a BAUD rate 115200.
	...
	\label{sub:motor_control}
		...
		\label{ssub:external_dual_h_bridge}
			...
			The speed of the motors are controlled by applying a Pulse Width Modulated (PWM) \fxnote{bare pwm måske?} signal to the EN pin for the corresponding motor (see \autoref{tab:motor_signal}).
