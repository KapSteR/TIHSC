...
\label{sec:hardware}
	...
	\label{sub:sensor}
		...
		The motor is designed to be powered by a pulse width modulated \fxnote{bare pwm?} 12V power supply, but in this project the motor is power by a 3.3V continuous supply \fxnote{ref til table 3.1b?}.
