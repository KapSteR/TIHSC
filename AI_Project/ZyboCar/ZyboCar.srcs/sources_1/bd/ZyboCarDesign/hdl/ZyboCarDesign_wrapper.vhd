...
entity ZyboCarDesign_wrapper is
  port (
...
architecture STRUCTURE of ZyboCarDesign_wrapper is
  component ZyboCarDesign is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
ZyboCarDesign_i: component ZyboCarDesign
    port map (
