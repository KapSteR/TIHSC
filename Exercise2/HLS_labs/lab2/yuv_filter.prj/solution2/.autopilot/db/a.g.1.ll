; ModuleID = 'C:/Users/Kasper/Documents/GitHub/TIHSC/Exercise2/HLS_labs/lab2/yuv_filter.prj/solution2/.autopilot/db/a.g.1.bc'
...
; <label>:4                                       ; preds = %3
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !98 ; [debug line = 53:1]
...
define internal fastcc void @yuv_scale(%struct.image_t.1* %in, %struct.image_t.1* %out, i8 zeroext %Y_scale, i8 zeroext %U_scale, i8 zeroext %V_scale) nounwind uwtable {
  ...
  call void (...)* @_ssdm_InlineSelf(i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !130 ; [debug line = 118:1]
  %in.addr = getelementptr inbounds %struct.image_t.1* %in, i64 0, i32 1, !dbg !132 ; [#uses=1 type=i16*] [debug line = 123:4]
  %width = load i16* %in.addr, align 2, !dbg !132 ; [#uses=3 type=i16] [debug line = 123:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %width) nounwind
  call void @llvm.dbg.value(metadata !{i16 %width}, i64 0, metadata !133), !dbg !132 ; [debug line = 123:4] [debug variable = width]
  %in.addr.5 = getelementptr inbounds %struct.image_t.1* %in, i64 0, i32 2, !dbg !134 ; [#uses=1 type=i16*] [debug line = 124:4]
  %height = load i16* %in.addr.5, align 2, !dbg !134 ; [#uses=3 type=i16] [debug line = 124:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %height) nounwind
  call void @llvm.dbg.value(metadata !{i16 %height}, i64 0, metadata !135), !dbg !134 ; [debug line = 124:4] [debug variable = height]
  %out.addr = getelementptr inbounds %struct.image_t.1* %out, i64 0, i32 1, !dbg !136 ; [#uses=1 type=i16*] [debug line = 125:4]
  store i16 %width, i16* %out.addr, align 2, !dbg !136 ; [debug line = 125:4]
  %out.addr.5 = getelementptr inbounds %struct.image_t.1* %out, i64 0, i32 2, !dbg !137 ; [#uses=1 type=i16*] [debug line = 126:4]
  store i16 %height, i16* %out.addr.5, align 2, !dbg !137 ; [debug line = 126:4]
  %tmp = zext i8 %Y_scale to i16, !dbg !138       ; [#uses=1 type=i16] [debug line = 137:10]
  %tmp.31 = zext i8 %U_scale to i16, !dbg !143    ; [#uses=1 type=i16] [debug line = 138:10]
  %tmp.32 = zext i8 %V_scale to i16, !dbg !144    ; [#uses=1 type=i16] [debug line = 139:10]
  br label %1, !dbg !145                          ; [debug line = 129:9]

; <label>:1                                       ; preds = %5, %0
  %x = phi i16 [ 0, %0 ], [ %x.2, %5 ]            ; [#uses=3 type=i16]
  %exitcond1 = icmp eq i16 %x, %width, !dbg !145  ; [#uses=1 type=i1] [debug line = 129:9]
  br i1 %exitcond1, label %6, label %2, !dbg !145 ; [debug line = 129:9]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([17 x i8]* @.str5, i64 0, i64 0)), !dbg !146 ; [debug line = 129:29]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([17 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !147 ; [#uses=1 type=i32] [debug line = 129:71]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1920, i32 1060, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !148 ; [debug line = 130:1]
  %tmp.33 = zext i16 %x to i64, !dbg !149         ; [#uses=6 type=i64] [debug line = 134:2]
  br label %3, !dbg !150                          ; [debug line = 132:12]

; <label>:3                                       ; preds = %4, %2
  %y = phi i16 [ 0, %2 ], [ %y.2, %4 ]            ; [#uses=3 type=i16]
  %exitcond = icmp eq i16 %y, %height, !dbg !150  ; [#uses=1 type=i1] [debug line = 132:12]
  br i1 %exitcond, label %5, label %4, !dbg !150  ; [debug line = 132:12]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([17 x i8]* @.str6, i64 0, i64 0)), !dbg !151 ; [debug line = 132:33]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([17 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !152 ; [#uses=1 type=i32] [debug line = 132:75]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !153 ; [debug line = 133:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1280, i32 740, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !153 ; [debug line = 133:1]
  %tmp.35 = zext i16 %y to i64, !dbg !149         ; [#uses=6 type=i64] [debug line = 134:2]
  %in.addr.6 = getelementptr inbounds %struct.image_t.1* %in, i64 0, i32 0, i32 0, i64 %tmp.33, i64 %tmp.35, !dbg !149 ; [#uses=1 type=i8*] [debug line = 134:2]
  %Y = load i8* %in.addr.6, align 1, !dbg !149    ; [#uses=2 type=i8] [debug line = 134:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %Y) nounwind
  call void @llvm.dbg.value(metadata !{i8 %Y}, i64 0, metadata !154), !dbg !149 ; [debug line = 134:2] [debug variable = Y]
  %in.addr.7 = getelementptr inbounds %struct.image_t.1* %in, i64 0, i32 0, i32 1, i64 %tmp.33, i64 %tmp.35, !dbg !155 ; [#uses=1 type=i8*] [debug line = 135:10]
  %U = load i8* %in.addr.7, align 1, !dbg !155    ; [#uses=2 type=i8] [debug line = 135:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %U) nounwind
  call void @llvm.dbg.value(metadata !{i8 %U}, i64 0, metadata !156), !dbg !155 ; [debug line = 135:10] [debug variable = U]
  %in.addr.8 = getelementptr inbounds %struct.image_t.1* %in, i64 0, i32 0, i32 2, i64 %tmp.33, i64 %tmp.35, !dbg !157 ; [#uses=1 type=i8*] [debug line = 136:10]
  %V = load i8* %in.addr.8, align 1, !dbg !157    ; [#uses=2 type=i8] [debug line = 136:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %V) nounwind
  call void @llvm.dbg.value(metadata !{i8 %V}, i64 0, metadata !158), !dbg !157 ; [debug line = 136:10] [debug variable = V]
  %tmp.36 = zext i8 %Y to i16, !dbg !138          ; [#uses=1 type=i16] [debug line = 137:10]
  %tmp.37 = mul i16 %tmp.36, %tmp, !dbg !138      ; [#uses=1 type=i16] [debug line = 137:10]
  %Yn = lshr i16 %tmp.37, 7, !dbg !138            ; [#uses=1 type=i16] [debug line = 137:10]
  call void @llvm.dbg.value(metadata !{i16 %Yn}, i64 0, metadata !159), !dbg !138 ; [debug line = 137:10] [debug variable = Yn]
  %tmp.39 = zext i8 %U to i16, !dbg !143          ; [#uses=1 type=i16] [debug line = 138:10]
  %tmp.40 = mul i16 %tmp.39, %tmp.31, !dbg !143   ; [#uses=1 type=i16] [debug line = 138:10]
  %Un = lshr i16 %tmp.40, 7, !dbg !143            ; [#uses=1 type=i16] [debug line = 138:10]
  call void @llvm.dbg.value(metadata !{i16 %Un}, i64 0, metadata !161), !dbg !143 ; [debug line = 138:10] [debug variable = Un]
  %tmp.42 = zext i8 %V to i16, !dbg !144          ; [#uses=1 type=i16] [debug line = 139:10]
  %tmp.43 = mul i16 %tmp.42, %tmp.32, !dbg !144   ; [#uses=1 type=i16] [debug line = 139:10]
  %Vn = lshr i16 %tmp.43, 7, !dbg !144            ; [#uses=1 type=i16] [debug line = 139:10]
  call void @llvm.dbg.value(metadata !{i16 %Vn}, i64 0, metadata !162), !dbg !144 ; [debug line = 139:10] [debug variable = Vn]
  %tmp.45 = trunc i16 %Yn to i8, !dbg !163        ; [#uses=1 type=i8] [debug line = 140:10]
  %out.addr.6 = getelementptr inbounds %struct.image_t.1* %out, i64 0, i32 0, i32 0, i64 %tmp.33, i64 %tmp.35, !dbg !163 ; [#uses=1 type=i8*] [debug line = 140:10]
  store i8 %tmp.45, i8* %out.addr.6, align 1, !dbg !163 ; [debug line = 140:10]
  %tmp.46 = trunc i16 %Un to i8, !dbg !164        ; [#uses=1 type=i8] [debug line = 141:10]
  %out.addr.7 = getelementptr inbounds %struct.image_t.1* %out, i64 0, i32 0, i32 1, i64 %tmp.33, i64 %tmp.35, !dbg !164 ; [#uses=1 type=i8*] [debug line = 141:10]
  store i8 %tmp.46, i8* %out.addr.7, align 1, !dbg !164 ; [debug line = 141:10]
  %tmp.47 = trunc i16 %Vn to i8, !dbg !165        ; [#uses=1 type=i8] [debug line = 142:10]
  %out.addr.8 = getelementptr inbounds %struct.image_t.1* %out, i64 0, i32 0, i32 2, i64 %tmp.33, i64 %tmp.35, !dbg !165 ; [#uses=1 type=i8*] [debug line = 142:10]
  store i8 %tmp.47, i8* %out.addr.8, align 1, !dbg !165 ; [debug line = 142:10]
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([17 x i8]* @.str6, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !166 ; [#uses=0 type=i32] [debug line = 143:7]
  %y.2 = add i16 %y, 1, !dbg !167                 ; [#uses=1 type=i16] [debug line = 132:27]
  call void @llvm.dbg.value(metadata !{i16 %y.2}, i64 0, metadata !168), !dbg !167 ; [debug line = 132:27] [debug variable = y]
  br label %3, !dbg !167                          ; [debug line = 132:27]

; <label>:5                                       ; preds = %3
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([17 x i8]* @.str5, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !169 ; [#uses=0 type=i32] [debug line = 144:4]
  %x.2 = add i16 %x, 1, !dbg !170                 ; [#uses=1 type=i16] [debug line = 129:23]
  call void @llvm.dbg.value(metadata !{i16 %x.2}, i64 0, metadata !171), !dbg !170 ; [debug line = 129:23] [debug variable = x]
  br label %1, !dbg !170                          ; [debug line = 129:23]

; <label>:6                                       ; preds = %1
  ret void, !dbg !172                             ; [debug line = 145:1]
}

; [#uses=1]
define internal fastcc void @yuv2rgb(%struct.image_t.1* %in, %struct.image_t.1* %out) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{%struct.image_t.1* %in}, i64 0, metadata !173), !dbg !174 ; [debug line = 68:16] [debug variable = in]
  call void @llvm.dbg.value(metadata !{%struct.image_t.1* %out}, i64 0, metadata !175), !dbg !176 ; [debug line = 69:16] [debug variable = out]
  %in.addr = getelementptr inbounds %struct.image_t.1* %in, i64 0, i32 1, !dbg !177 ; [#uses=1 type=i16*] [debug line = 83:4]
  %width = load i16* %in.addr, align 2, !dbg !177 ; [#uses=3 type=i16] [debug line = 83:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %width) nounwind
  call void @llvm.dbg.value(metadata !{i16 %width}, i64 0, metadata !179), !dbg !177 ; [debug line = 83:4] [debug variable = width]
  %in.addr.9 = getelementptr inbounds %struct.image_t.1* %in, i64 0, i32 2, !dbg !180 ; [#uses=1 type=i16*] [debug line = 84:4]
  %height = load i16* %in.addr.9, align 2, !dbg !180 ; [#uses=3 type=i16] [debug line = 84:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %height) nounwind
  call void @llvm.dbg.value(metadata !{i16 %height}, i64 0, metadata !181), !dbg !180 ; [debug line = 84:4] [debug variable = height]
  %out.addr = getelementptr inbounds %struct.image_t.1* %out, i64 0, i32 1, !dbg !182 ; [#uses=1 type=i16*] [debug line = 85:4]
  store i16 %width, i16* %out.addr, align 2, !dbg !182 ; [debug line = 85:4]
  %out.addr.9 = getelementptr inbounds %struct.image_t.1* %out, i64 0, i32 2, !dbg !183 ; [#uses=1 type=i16*] [debug line = 86:4]
  store i16 %height, i16* %out.addr.9, align 2, !dbg !183 ; [debug line = 86:4]
  br label %1, !dbg !184                          ; [debug line = 89:9]

; <label>:1                                       ; preds = %11, %0
  %x = phi i16 [ 0, %0 ], [ %x.3, %11 ]           ; [#uses=3 type=i16]
  %exitcond1 = icmp eq i16 %x, %width, !dbg !184  ; [#uses=1 type=i1] [debug line = 89:9]
  br i1 %exitcond1, label %12, label %2, !dbg !184 ; [debug line = 89:9]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str3, i64 0, i64 0)), !dbg !186 ; [debug line = 89:29]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !188 ; [#uses=1 type=i32] [debug line = 89:69]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1920, i32 1060, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !189 ; [debug line = 90:1]
  %tmp = zext i16 %x to i64, !dbg !190            ; [#uses=6 type=i64] [debug line = 94:2]
  br label %3, !dbg !193                          ; [debug line = 92:12]

; <label>:3                                       ; preds = %._crit_edge7, %2
  %y = phi i16 [ 0, %2 ], [ %y.3, %._crit_edge7 ] ; [#uses=3 type=i16]
  %exitcond = icmp eq i16 %y, %height, !dbg !193  ; [#uses=1 type=i1] [debug line = 92:12]
  br i1 %exitcond, label %11, label %4, !dbg !193 ; [debug line = 92:12]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str4, i64 0, i64 0)), !dbg !194 ; [debug line = 92:33]
  %rbegin9 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !195 ; [#uses=1 type=i32] [debug line = 92:73]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !196 ; [debug line = 93:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1280, i32 740, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !196 ; [debug line = 93:1]
  %tmp.50 = zext i16 %y to i64, !dbg !190         ; [#uses=6 type=i64] [debug line = 94:2]
  %in.addr.10 = getelementptr inbounds %struct.image_t.1* %in, i64 0, i32 0, i32 0, i64 %tmp, i64 %tmp.50, !dbg !190 ; [#uses=1 type=i8*] [debug line = 94:2]
  %Y = load i8* %in.addr.10, align 1, !dbg !190   ; [#uses=2 type=i8] [debug line = 94:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %Y) nounwind
  call void @llvm.dbg.value(metadata !{i8 %Y}, i64 0, metadata !197), !dbg !190 ; [debug line = 94:2] [debug variable = Y]
  %in.addr.11 = getelementptr inbounds %struct.image_t.1* %in, i64 0, i32 0, i32 1, i64 %tmp, i64 %tmp.50, !dbg !198 ; [#uses=1 type=i8*] [debug line = 95:10]
  %U = load i8* %in.addr.11, align 1, !dbg !198   ; [#uses=2 type=i8] [debug line = 95:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %U) nounwind
  call void @llvm.dbg.value(metadata !{i8 %U}, i64 0, metadata !199), !dbg !198 ; [debug line = 95:10] [debug variable = U]
  %in.addr.12 = getelementptr inbounds %struct.image_t.1* %in, i64 0, i32 0, i32 2, i64 %tmp, i64 %tmp.50, !dbg !200 ; [#uses=1 type=i8*] [debug line = 96:10]
  %V = load i8* %in.addr.12, align 1, !dbg !200   ; [#uses=2 type=i8] [debug line = 96:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %V) nounwind
  call void @llvm.dbg.value(metadata !{i8 %V}, i64 0, metadata !201), !dbg !200 ; [debug line = 96:10] [debug variable = V]
  %tmp.51 = zext i8 %Y to i16, !dbg !202          ; [#uses=1 type=i16] [debug line = 97:10]
  %C = add i16 %tmp.51, -16, !dbg !202            ; [#uses=1 type=i16] [debug line = 97:10]
  call void @llvm.dbg.value(metadata !{i16 %C}, i64 0, metadata !203), !dbg !202 ; [debug line = 97:10] [debug variable = C]
  %tmp.53 = zext i8 %U to i16, !dbg !204          ; [#uses=1 type=i16] [debug line = 98:10]
  %D = add i16 %tmp.53, -128, !dbg !204           ; [#uses=1 type=i16] [debug line = 98:10]
  call void @llvm.dbg.value(metadata !{i16 %D}, i64 0, metadata !205), !dbg !204 ; [debug line = 98:10] [debug variable = D]
  %tmp.55 = zext i8 %V to i16, !dbg !206          ; [#uses=1 type=i16] [debug line = 99:10]
  %E = add i16 %tmp.55, -128, !dbg !206           ; [#uses=1 type=i16] [debug line = 99:10]
  call void @llvm.dbg.value(metadata !{i16 %E}, i64 0, metadata !207), !dbg !206 ; [debug line = 99:10] [debug variable = E]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 298) nounwind
  %tmp.57 = sext i16 %C to i32, !dbg !208         ; [#uses=1 type=i32] [debug line = 100:10]
  %tmp.58 = mul nsw i32 %tmp.57, 298, !dbg !208   ; [#uses=1 type=i32] [debug line = 100:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 409) nounwind
  %tmp.59 = sext i16 %E to i32, !dbg !208         ; [#uses=2 type=i32] [debug line = 100:10]
  %tmp.60 = mul nsw i32 %tmp.59, 409, !dbg !208   ; [#uses=1 type=i32] [debug line = 100:10]
  %tmp.61 = add i32 %tmp.58, 128, !dbg !208       ; [#uses=3 type=i32] [debug line = 100:10]
  %tmp.62 = add i32 %tmp.60, %tmp.61, !dbg !208   ; [#uses=3 type=i32] [debug line = 100:10]
  %tmp.63 = ashr i32 %tmp.62, 8, !dbg !208        ; [#uses=1 type=i32] [debug line = 100:10]
  %tmp.64 = icmp sgt i32 %tmp.63, 255, !dbg !208  ; [#uses=1 type=i1] [debug line = 100:10]
  br i1 %tmp.64, label %._crit_edge, label %5, !dbg !208 ; [debug line = 100:10]

; <label>:5                                       ; preds = %4
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 298) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 409) nounwind
  %tmp.65 = icmp slt i32 %tmp.62, 0, !dbg !208    ; [#uses=1 type=i1] [debug line = 100:10]
  br i1 %tmp.65, label %._crit_edge, label %6, !dbg !208 ; [debug line = 100:10]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 298) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 409) nounwind
  %tmp.66 = lshr i32 %tmp.62, 8, !dbg !208        ; [#uses=1 type=i32] [debug line = 100:10]
  %phitmp = trunc i32 %tmp.66 to i8, !dbg !208    ; [#uses=1 type=i8] [debug line = 100:10]
  br label %._crit_edge, !dbg !208                ; [debug line = 100:10]

._crit_edge:                                      ; preds = %6, %5, %4
  %R = phi i8 [ %phitmp, %6 ], [ -1, %4 ], [ 0, %5 ], !dbg !208 ; [#uses=1 type=i8] [debug line = 100:10]
  call void @llvm.dbg.value(metadata !{i8 %R}, i64 0, metadata !209), !dbg !208 ; [debug line = 100:10] [debug variable = R]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 298) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 -100) nounwind
  %tmp.68 = sext i16 %D to i32, !dbg !210         ; [#uses=2 type=i32] [debug line = 101:10]
  %tmp.69 = mul nsw i32 %tmp.68, -100, !dbg !210  ; [#uses=1 type=i32] [debug line = 101:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 -208) nounwind
  %tmp.70 = mul nsw i32 %tmp.59, -208, !dbg !210  ; [#uses=1 type=i32] [debug line = 101:10]
  %tmp.71 = add i32 %tmp.69, %tmp.61, !dbg !210   ; [#uses=1 type=i32] [debug line = 101:10]
  %tmp.72 = add i32 %tmp.71, %tmp.70, !dbg !210   ; [#uses=3 type=i32] [debug line = 101:10]
  %tmp.73 = ashr i32 %tmp.72, 8, !dbg !210        ; [#uses=1 type=i32] [debug line = 101:10]
  %tmp.74 = icmp sgt i32 %tmp.73, 255, !dbg !210  ; [#uses=1 type=i1] [debug line = 101:10]
  br i1 %tmp.74, label %._crit_edge5, label %7, !dbg !210 ; [debug line = 101:10]

; <label>:7                                       ; preds = %._crit_edge
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 298) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 -100) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 -208) nounwind
  %tmp.75 = icmp slt i32 %tmp.72, 0, !dbg !210    ; [#uses=1 type=i1] [debug line = 101:10]
  br i1 %tmp.75, label %._crit_edge5, label %8, !dbg !210 ; [debug line = 101:10]

; <label>:8                                       ; preds = %7
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 298) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 -100) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 -208) nounwind
  %tmp.76 = lshr i32 %tmp.72, 8, !dbg !210        ; [#uses=1 type=i32] [debug line = 101:10]
  %phitmp2 = trunc i32 %tmp.76 to i8, !dbg !210   ; [#uses=1 type=i8] [debug line = 101:10]
  br label %._crit_edge5, !dbg !210               ; [debug line = 101:10]

._crit_edge5:                                     ; preds = %8, %7, %._crit_edge
  %G = phi i8 [ %phitmp2, %8 ], [ -1, %._crit_edge ], [ 0, %7 ], !dbg !210 ; [#uses=1 type=i8] [debug line = 101:10]
  call void @llvm.dbg.value(metadata !{i8 %G}, i64 0, metadata !211), !dbg !210 ; [debug line = 101:10] [debug variable = G]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 298) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 516) nounwind
  %tmp.78 = mul nsw i32 %tmp.68, 516, !dbg !212   ; [#uses=1 type=i32] [debug line = 102:10]
  %tmp.79 = add i32 %tmp.78, %tmp.61, !dbg !212   ; [#uses=3 type=i32] [debug line = 102:10]
  %tmp.80 = ashr i32 %tmp.79, 8, !dbg !212        ; [#uses=1 type=i32] [debug line = 102:10]
  %tmp.81 = icmp sgt i32 %tmp.80, 255, !dbg !212  ; [#uses=1 type=i1] [debug line = 102:10]
  br i1 %tmp.81, label %._crit_edge7, label %9, !dbg !212 ; [debug line = 102:10]

; <label>:9                                       ; preds = %._crit_edge5
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 298) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 516) nounwind
  %tmp.82 = icmp slt i32 %tmp.79, 0, !dbg !212    ; [#uses=1 type=i1] [debug line = 102:10]
  br i1 %tmp.82, label %._crit_edge7, label %10, !dbg !212 ; [debug line = 102:10]

; <label>:10                                      ; preds = %9
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 298) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 516) nounwind
  %tmp.83 = lshr i32 %tmp.79, 8, !dbg !212        ; [#uses=1 type=i32] [debug line = 102:10]
  %phitmp3 = trunc i32 %tmp.83 to i8, !dbg !212   ; [#uses=1 type=i8] [debug line = 102:10]
  br label %._crit_edge7, !dbg !212               ; [debug line = 102:10]

._crit_edge7:                                     ; preds = %10, %9, %._crit_edge5
  %B = phi i8 [ %phitmp3, %10 ], [ -1, %._crit_edge5 ], [ 0, %9 ], !dbg !212 ; [#uses=1 type=i8] [debug line = 102:10]
  call void @llvm.dbg.value(metadata !{i8 %B}, i64 0, metadata !213), !dbg !212 ; [debug line = 102:10] [debug variable = B]
  %out.addr.10 = getelementptr inbounds %struct.image_t.1* %out, i64 0, i32 0, i32 0, i64 %tmp, i64 %tmp.50, !dbg !214 ; [#uses=1 type=i8*] [debug line = 103:10]
  store i8 %R, i8* %out.addr.10, align 1, !dbg !214 ; [debug line = 103:10]
  %out.addr.11 = getelementptr inbounds %struct.image_t.1* %out, i64 0, i32 0, i32 1, i64 %tmp, i64 %tmp.50, !dbg !215 ; [#uses=1 type=i8*] [debug line = 104:10]
  store i8 %G, i8* %out.addr.11, align 1, !dbg !215 ; [debug line = 104:10]
  %out.addr.12 = getelementptr inbounds %struct.image_t.1* %out, i64 0, i32 0, i32 2, i64 %tmp, i64 %tmp.50, !dbg !216 ; [#uses=1 type=i8*] [debug line = 105:10]
  store i8 %B, i8* %out.addr.12, align 1, !dbg !216 ; [debug line = 105:10]
  %rend10 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str4, i64 0, i64 0), i32 %rbegin9) nounwind, !dbg !217 ; [#uses=0 type=i32] [debug line = 106:7]
  %y.3 = add i16 %y, 1, !dbg !218                 ; [#uses=1 type=i16] [debug line = 92:27]
  call void @llvm.dbg.value(metadata !{i16 %y.3}, i64 0, metadata !219), !dbg !218 ; [debug line = 92:27] [debug variable = y]
  br label %3, !dbg !218                          ; [debug line = 92:27]

; <label>:11                                      ; preds = %3
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str3, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !220 ; [#uses=0 type=i32] [debug line = 107:4]
  %x.3 = add i16 %x, 1, !dbg !221                 ; [#uses=1 type=i16] [debug line = 89:23]
  call void @llvm.dbg.value(metadata !{i16 %x.3}, i64 0, metadata !222), !dbg !221 ; [debug line = 89:23] [debug variable = x]
  br label %1, !dbg !221                          ; [debug line = 89:23]

; <label>:12                                      ; preds = %1
  ret void, !dbg !223                             ; [debug line = 108:1]
}
...
!130 = metadata !{i32 118, i32 1, metadata !131, null}
!131 = metadata !{i32 786443, metadata !38, i32 117, i32 1, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
!132 = metadata !{i32 123, i32 4, metadata !131, null}
!133 = metadata !{i32 786688, metadata !131, metadata !"width", metadata !6, i32 119, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!134 = metadata !{i32 124, i32 4, metadata !131, null}
!135 = metadata !{i32 786688, metadata !131, metadata !"height", metadata !6, i32 119, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!136 = metadata !{i32 125, i32 4, metadata !131, null}
!137 = metadata !{i32 126, i32 4, metadata !131, null}
!138 = metadata !{i32 137, i32 10, metadata !139, null}
!139 = metadata !{i32 786443, metadata !140, i32 132, i32 32, metadata !6, i32 15} ; [ DW_TAG_lexical_block ]
!140 = metadata !{i32 786443, metadata !141, i32 132, i32 7, metadata !6, i32 14} ; [ DW_TAG_lexical_block ]
!141 = metadata !{i32 786443, metadata !142, i32 129, i32 28, metadata !6, i32 13} ; [ DW_TAG_lexical_block ]
!142 = metadata !{i32 786443, metadata !131, i32 129, i32 4, metadata !6, i32 12} ; [ DW_TAG_lexical_block ]
!143 = metadata !{i32 138, i32 10, metadata !139, null}
!144 = metadata !{i32 139, i32 10, metadata !139, null}
!145 = metadata !{i32 129, i32 9, metadata !142, null}
!146 = metadata !{i32 129, i32 29, metadata !141, null}
!147 = metadata !{i32 129, i32 71, metadata !141, null}
!148 = metadata !{i32 130, i32 1, metadata !141, null}
!149 = metadata !{i32 134, i32 2, metadata !139, null}
!150 = metadata !{i32 132, i32 12, metadata !140, null}
!151 = metadata !{i32 132, i32 33, metadata !139, null}
!152 = metadata !{i32 132, i32 75, metadata !139, null}
!153 = metadata !{i32 133, i32 1, metadata !139, null}
!154 = metadata !{i32 786688, metadata !131, metadata !"Y", metadata !6, i32 120, metadata !20, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!155 = metadata !{i32 135, i32 10, metadata !139, null}
!156 = metadata !{i32 786688, metadata !131, metadata !"U", metadata !6, i32 120, metadata !20, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!157 = metadata !{i32 136, i32 10, metadata !139, null}
!158 = metadata !{i32 786688, metadata !131, metadata !"V", metadata !6, i32 120, metadata !20, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!159 = metadata !{i32 786688, metadata !131, metadata !"Yn", metadata !6, i32 121, metadata !160, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!160 = metadata !{i32 786454, null, metadata !"yuv_intrnl_t", metadata !6, i32 16, i64 0, i64 0, i64 0, i32 0, metadata !45} ; [ DW_TAG_typedef ]
!161 = metadata !{i32 786688, metadata !131, metadata !"Un", metadata !6, i32 121, metadata !160, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!162 = metadata !{i32 786688, metadata !131, metadata !"Vn", metadata !6, i32 121, metadata !160, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!163 = metadata !{i32 140, i32 10, metadata !139, null}
!164 = metadata !{i32 141, i32 10, metadata !139, null}
!165 = metadata !{i32 142, i32 10, metadata !139, null}
!166 = metadata !{i32 143, i32 7, metadata !139, null}
!167 = metadata !{i32 132, i32 27, metadata !140, null}
!168 = metadata !{i32 786688, metadata !131, metadata !"y", metadata !6, i32 118, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!169 = metadata !{i32 144, i32 4, metadata !141, null}
!170 = metadata !{i32 129, i32 23, metadata !142, null}
!171 = metadata !{i32 786688, metadata !131, metadata !"x", metadata !6, i32 118, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!172 = metadata !{i32 145, i32 1, metadata !131, null}
!173 = metadata !{i32 786689, metadata !37, metadata !"in", metadata !6, i32 16777284, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!174 = metadata !{i32 68, i32 16, metadata !37, null}
!175 = metadata !{i32 786689, metadata !37, metadata !"out", metadata !6, i32 33554501, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!176 = metadata !{i32 69, i32 16, metadata !37, null}
!177 = metadata !{i32 83, i32 4, metadata !178, null}
!178 = metadata !{i32 786443, metadata !37, i32 71, i32 1, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!179 = metadata !{i32 786688, metadata !178, metadata !"width", metadata !6, i32 73, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!180 = metadata !{i32 84, i32 4, metadata !178, null}
!181 = metadata !{i32 786688, metadata !178, metadata !"height", metadata !6, i32 73, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!182 = metadata !{i32 85, i32 4, metadata !178, null}
!183 = metadata !{i32 86, i32 4, metadata !178, null}
!184 = metadata !{i32 89, i32 9, metadata !185, null}
!185 = metadata !{i32 786443, metadata !178, i32 89, i32 4, metadata !6, i32 7} ; [ DW_TAG_lexical_block ]
!186 = metadata !{i32 89, i32 29, metadata !187, null}
!187 = metadata !{i32 786443, metadata !185, i32 89, i32 28, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!188 = metadata !{i32 89, i32 69, metadata !187, null}
!189 = metadata !{i32 90, i32 1, metadata !187, null}
!190 = metadata !{i32 94, i32 2, metadata !191, null}
!191 = metadata !{i32 786443, metadata !192, i32 92, i32 32, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
!192 = metadata !{i32 786443, metadata !187, i32 92, i32 7, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
!193 = metadata !{i32 92, i32 12, metadata !192, null}
!194 = metadata !{i32 92, i32 33, metadata !191, null}
!195 = metadata !{i32 92, i32 73, metadata !191, null}
!196 = metadata !{i32 93, i32 1, metadata !191, null}
!197 = metadata !{i32 786688, metadata !178, metadata !"Y", metadata !6, i32 75, metadata !20, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!198 = metadata !{i32 95, i32 10, metadata !191, null}
!199 = metadata !{i32 786688, metadata !178, metadata !"U", metadata !6, i32 75, metadata !20, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!200 = metadata !{i32 96, i32 10, metadata !191, null}
!201 = metadata !{i32 786688, metadata !178, metadata !"V", metadata !6, i32 75, metadata !20, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!202 = metadata !{i32 97, i32 10, metadata !191, null}
!203 = metadata !{i32 786688, metadata !178, metadata !"C", metadata !6, i32 76, metadata !160, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!204 = metadata !{i32 98, i32 10, metadata !191, null}
!205 = metadata !{i32 786688, metadata !178, metadata !"D", metadata !6, i32 76, metadata !160, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!206 = metadata !{i32 99, i32 10, metadata !191, null}
!207 = metadata !{i32 786688, metadata !178, metadata !"E", metadata !6, i32 76, metadata !160, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!208 = metadata !{i32 100, i32 10, metadata !191, null}
!209 = metadata !{i32 786688, metadata !178, metadata !"R", metadata !6, i32 74, metadata !20, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!210 = metadata !{i32 101, i32 10, metadata !191, null}
!211 = metadata !{i32 786688, metadata !178, metadata !"G", metadata !6, i32 74, metadata !20, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!212 = metadata !{i32 102, i32 10, metadata !191, null}
!213 = metadata !{i32 786688, metadata !178, metadata !"B", metadata !6, i32 74, metadata !20, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!214 = metadata !{i32 103, i32 10, metadata !191, null}
!215 = metadata !{i32 104, i32 10, metadata !191, null}
!216 = metadata !{i32 105, i32 10, metadata !191, null}
!217 = metadata !{i32 106, i32 7, metadata !191, null}
!218 = metadata !{i32 92, i32 27, metadata !192, null}
!219 = metadata !{i32 786688, metadata !178, metadata !"y", metadata !6, i32 72, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!220 = metadata !{i32 107, i32 4, metadata !187, null}
!221 = metadata !{i32 89, i32 23, metadata !185, null}
!222 = metadata !{i32 786688, metadata !178, metadata !"x", metadata !6, i32 72, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!223 = metadata !{i32 108, i32 1, metadata !178, null}
