...
set DataType00 [list "channel_t" "struct " $structMem00 0 0 ]
...
set DataType0 [list "image_t" "struct " $structMem0 0 0 ]
...
set DataType10 [list "channel_t" "struct " $structMem10 0 0 ]
...
set DataType1 [list "image_t" "struct " $structMem1 0 0 ]
