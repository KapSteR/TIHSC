...
architecture behav of yuv_filter is 
    ...
    "yuv_filter,hls_ip_2014_4,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.718500,HLS_SYN_LAT=824408,HLS_SYN_TPT=784408,HLS_SYN_MEM=0,HLS_SYN_DSP=15,HLS_SYN_FF=851,HLS_SYN_LUT=1158}";
    ...
    signal yuv_filter_rgb2yuv_U0_ap_start : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_ap_done : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_ap_continue : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_ap_idle : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_ap_ready : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_in_channels_ch1_address0 : STD_LOGIC_VECTOR (21 downto 0);
    signal yuv_filter_rgb2yuv_U0_in_channels_ch1_ce0 : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_in_channels_ch1_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_rgb2yuv_U0_in_channels_ch2_address0 : STD_LOGIC_VECTOR (21 downto 0);
    signal yuv_filter_rgb2yuv_U0_in_channels_ch2_ce0 : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_in_channels_ch2_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_rgb2yuv_U0_in_channels_ch3_address0 : STD_LOGIC_VECTOR (21 downto 0);
    signal yuv_filter_rgb2yuv_U0_in_channels_ch3_ce0 : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_in_channels_ch3_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_rgb2yuv_U0_in_width : STD_LOGIC_VECTOR (15 downto 0);
    signal yuv_filter_rgb2yuv_U0_in_height : STD_LOGIC_VECTOR (15 downto 0);
    signal yuv_filter_rgb2yuv_U0_out_channels_ch1_din : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_rgb2yuv_U0_out_channels_ch1_full_n : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_out_channels_ch1_write : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_out_channels_ch2_din : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_rgb2yuv_U0_out_channels_ch2_full_n : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_out_channels_ch2_write : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_out_channels_ch3_din : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_rgb2yuv_U0_out_channels_ch3_full_n : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_out_channels_ch3_write : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_out_width_din : STD_LOGIC_VECTOR (15 downto 0);
    signal yuv_filter_rgb2yuv_U0_out_width_full_n : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_out_width_write : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_out_height_din : STD_LOGIC_VECTOR (15 downto 0);
    signal yuv_filter_rgb2yuv_U0_out_height_full_n : STD_LOGIC;
    signal yuv_filter_rgb2yuv_U0_out_height_write : STD_LOGIC;
    signal yuv_filter_yuv_scale_U0_ap_start : STD_LOGIC;
    ...
    signal yuv_filter_yuv_scale_U0_in_channels_ch1_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_yuv_scale_U0_in_channels_ch1_empty_n : STD_LOGIC;
    signal yuv_filter_yuv_scale_U0_in_channels_ch1_read : STD_LOGIC;
    signal yuv_filter_yuv_scale_U0_in_channels_ch2_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_yuv_scale_U0_in_channels_ch2_empty_n : STD_LOGIC;
    signal yuv_filter_yuv_scale_U0_in_channels_ch2_read : STD_LOGIC;
    signal yuv_filter_yuv_scale_U0_in_channels_ch3_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_yuv_scale_U0_in_channels_ch3_empty_n : STD_LOGIC;
    signal yuv_filter_yuv_scale_U0_in_channels_ch3_read : STD_LOGIC;
    signal yuv_filter_yuv_scale_U0_in_width_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal yuv_filter_yuv_scale_U0_in_width_empty_n : STD_LOGIC;
    signal yuv_filter_yuv_scale_U0_in_width_read : STD_LOGIC;
    signal yuv_filter_yuv_scale_U0_in_height_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal yuv_filter_yuv_scale_U0_in_height_empty_n : STD_LOGIC;
    ...
    signal yuv_filter_yuv_scale_U0_out_channels_ch1_full_n : STD_LOGIC;
    ...
    signal yuv_filter_yuv_scale_U0_out_channels_ch2_full_n : STD_LOGIC;
    ...
    signal yuv_filter_yuv_scale_U0_out_channels_ch3_full_n : STD_LOGIC;
    ...
    signal yuv_filter_yuv_scale_U0_out_width_full_n : STD_LOGIC;
    ...
    signal yuv_filter_yuv_scale_U0_out_height_full_n : STD_LOGIC;
    signal yuv_filter_yuv_scale_U0_out_height_write : STD_LOGIC;
    signal yuv_filter_yuv_scale_U0_Y_scale : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_yuv_scale_U0_U_scale : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_yuv_scale_U0_V_scale : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal yuv_filter_yuv2rgb_U0_in_channels_ch1_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_yuv2rgb_U0_in_channels_ch1_empty_n : STD_LOGIC;
    signal yuv_filter_yuv2rgb_U0_in_channels_ch1_read : STD_LOGIC;
    signal yuv_filter_yuv2rgb_U0_in_channels_ch2_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_yuv2rgb_U0_in_channels_ch2_empty_n : STD_LOGIC;
    signal yuv_filter_yuv2rgb_U0_in_channels_ch2_read : STD_LOGIC;
    signal yuv_filter_yuv2rgb_U0_in_channels_ch3_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal yuv_filter_yuv2rgb_U0_in_channels_ch3_empty_n : STD_LOGIC;
    signal yuv_filter_yuv2rgb_U0_in_channels_ch3_read : STD_LOGIC;
    signal yuv_filter_yuv2rgb_U0_in_width_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal yuv_filter_yuv2rgb_U0_in_width_empty_n : STD_LOGIC;
    signal yuv_filter_yuv2rgb_U0_in_width_read : STD_LOGIC;
    signal yuv_filter_yuv2rgb_U0_in_height_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal yuv_filter_yuv2rgb_U0_in_height_empty_n : STD_LOGIC;
    ...
    signal p_yuv_channels_ch1_U_ap_dummy_ce : STD_LOGIC;
    signal p_yuv_channels_ch1_din : STD_LOGIC_VECTOR (7 downto 0);
    signal p_yuv_channels_ch1_full_n : STD_LOGIC;
    signal p_yuv_channels_ch1_write : STD_LOGIC;
    signal p_yuv_channels_ch1_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal p_yuv_channels_ch1_empty_n : STD_LOGIC;
    signal p_yuv_channels_ch1_read : STD_LOGIC;
    signal p_yuv_channels_ch2_U_ap_dummy_ce : STD_LOGIC;
    signal p_yuv_channels_ch2_din : STD_LOGIC_VECTOR (7 downto 0);
    signal p_yuv_channels_ch2_full_n : STD_LOGIC;
    signal p_yuv_channels_ch2_write : STD_LOGIC;
    signal p_yuv_channels_ch2_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal p_yuv_channels_ch2_empty_n : STD_LOGIC;
    signal p_yuv_channels_ch2_read : STD_LOGIC;
    signal p_yuv_channels_ch3_U_ap_dummy_ce : STD_LOGIC;
    signal p_yuv_channels_ch3_din : STD_LOGIC_VECTOR (7 downto 0);
    signal p_yuv_channels_ch3_full_n : STD_LOGIC;
    signal p_yuv_channels_ch3_write : STD_LOGIC;
    signal p_yuv_channels_ch3_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal p_yuv_channels_ch3_empty_n : STD_LOGIC;
    signal p_yuv_channels_ch3_read : STD_LOGIC;
    signal p_yuv_width_U_ap_dummy_ce : STD_LOGIC;
    signal p_yuv_width_din : STD_LOGIC_VECTOR (15 downto 0);
    signal p_yuv_width_full_n : STD_LOGIC;
    signal p_yuv_width_write : STD_LOGIC;
    signal p_yuv_width_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal p_yuv_width_empty_n : STD_LOGIC;
    signal p_yuv_width_read : STD_LOGIC;
    signal p_yuv_height_U_ap_dummy_ce : STD_LOGIC;
    signal p_yuv_height_din : STD_LOGIC_VECTOR (15 downto 0);
    signal p_yuv_height_full_n : STD_LOGIC;
    signal p_yuv_height_write : STD_LOGIC;
    signal p_yuv_height_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal p_yuv_height_empty_n : STD_LOGIC;
    signal p_yuv_height_read : STD_LOGIC;
    signal p_scale_channels_ch1_U_ap_dummy_ce : STD_LOGIC;
    signal p_scale_channels_ch1_din : STD_LOGIC_VECTOR (7 downto 0);
    signal p_scale_channels_ch1_full_n : STD_LOGIC;
    signal p_scale_channels_ch1_write : STD_LOGIC;
    signal p_scale_channels_ch1_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal p_scale_channels_ch1_empty_n : STD_LOGIC;
    signal p_scale_channels_ch1_read : STD_LOGIC;
    signal p_scale_channels_ch2_U_ap_dummy_ce : STD_LOGIC;
    signal p_scale_channels_ch2_din : STD_LOGIC_VECTOR (7 downto 0);
    signal p_scale_channels_ch2_full_n : STD_LOGIC;
    signal p_scale_channels_ch2_write : STD_LOGIC;
    signal p_scale_channels_ch2_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal p_scale_channels_ch2_empty_n : STD_LOGIC;
    signal p_scale_channels_ch2_read : STD_LOGIC;
    signal p_scale_channels_ch3_U_ap_dummy_ce : STD_LOGIC;
    signal p_scale_channels_ch3_din : STD_LOGIC_VECTOR (7 downto 0);
    signal p_scale_channels_ch3_full_n : STD_LOGIC;
    signal p_scale_channels_ch3_write : STD_LOGIC;
    signal p_scale_channels_ch3_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal p_scale_channels_ch3_empty_n : STD_LOGIC;
    signal p_scale_channels_ch3_read : STD_LOGIC;
    signal p_scale_width_U_ap_dummy_ce : STD_LOGIC;
    signal p_scale_width_din : STD_LOGIC_VECTOR (15 downto 0);
    signal p_scale_width_full_n : STD_LOGIC;
    signal p_scale_width_write : STD_LOGIC;
    signal p_scale_width_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal p_scale_width_empty_n : STD_LOGIC;
    signal p_scale_width_read : STD_LOGIC;
    signal p_scale_height_U_ap_dummy_ce : STD_LOGIC;
    signal p_scale_height_din : STD_LOGIC_VECTOR (15 downto 0);
    signal p_scale_height_full_n : STD_LOGIC;
    signal p_scale_height_write : STD_LOGIC;
    signal p_scale_height_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal p_scale_height_empty_n : STD_LOGIC;
    signal p_scale_height_read : STD_LOGIC;
    signal ap_reg_procdone_yuv_filter_rgb2yuv_U0 : STD_LOGIC := '0';
    signal ap_sig_hs_done : STD_LOGIC;
    signal ap_reg_procdone_yuv_filter_yuv_scale_U0 : STD_LOGIC := '0';
    signal ap_reg_procdone_yuv_filter_yuv2rgb_U0 : STD_LOGIC := '0';
    signal ap_CS : STD_LOGIC;
    signal ap_sig_top_allready : STD_LOGIC;
    signal ap_reg_ready_yuv_filter_rgb2yuv_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sig_ready_yuv_filter_rgb2yuv_U0_ap_ready : STD_LOGIC;
    signal ap_sig_start_in_yuv_filter_rgb2yuv_U0_ap_start : STD_LOGIC;
    signal ap_reg_ready_yuv_filter_yuv_scale_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sig_ready_yuv_filter_yuv_scale_U0_ap_ready : STD_LOGIC;
    signal ap_sig_start_in_yuv_filter_yuv_scale_U0_ap_start : STD_LOGIC;
...
begin
    yuv_filter_rgb2yuv_U0 : component yuv_filter_rgb2yuv
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ap_reg_procdone_yuv_filter_rgb2yuv_U0_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_sig_hs_done)) then 
                    ap_reg_procdone_yuv_filter_rgb2yuv_U0 <= ap_const_logic_0;
                elsif ((yuv_filter_rgb2yuv_U0_ap_done = ap_const_logic_1)) then 
    ...
    ap_reg_procdone_yuv_filter_yuv2rgb_U0_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_sig_hs_done)) then 
                    ap_reg_procdone_yuv_filter_yuv2rgb_U0 <= ap_const_logic_0;
                elsif ((ap_const_logic_1 = yuv_filter_yuv2rgb_U0_ap_done)) then 
    ...
    ap_reg_procdone_yuv_filter_yuv_scale_U0_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_sig_hs_done)) then 
                    ap_reg_procdone_yuv_filter_yuv_scale_U0 <= ap_const_logic_0;
                elsif ((ap_const_logic_1 = yuv_filter_yuv_scale_U0_ap_done)) then 
    ...
    ap_reg_ready_yuv_filter_rgb2yuv_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_start) and (ap_const_logic_1 = ap_sig_top_allready))) then 
                    ap_reg_ready_yuv_filter_rgb2yuv_U0_ap_ready <= ap_const_logic_0;
                elsif ((yuv_filter_rgb2yuv_U0_ap_ready = ap_const_logic_1)) then 
    ...
    ap_reg_ready_yuv_filter_yuv_scale_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_start) and (ap_const_logic_1 = ap_sig_top_allready))) then 
                    ap_reg_ready_yuv_filter_yuv_scale_U0_ap_ready <= ap_const_logic_0;
                elsif ((ap_const_logic_1 = yuv_filter_yuv_scale_U0_ap_ready)) then 
    ...
    ap_idle_assign_proc : process(yuv_filter_rgb2yuv_U0_ap_idle, yuv_filter_yuv_scale_U0_ap_idle, yuv_filter_yuv2rgb_U0_ap_idle)
    begin
        if (((yuv_filter_rgb2yuv_U0_ap_idle = ap_const_logic_1) and (ap_const_logic_1 = yuv_filter_yuv_scale_U0_ap_idle) and (ap_const_logic_1 = yuv_filter_yuv2rgb_U0_ap_idle))) then 
    ...
    ap_sig_ready_yuv_filter_rgb2yuv_U0_ap_ready_assign_proc : process(yuv_filter_rgb2yuv_U0_ap_ready, ap_reg_ready_yuv_filter_rgb2yuv_U0_ap_ready)
    begin
        if ((ap_const_logic_0 = ap_reg_ready_yuv_filter_rgb2yuv_U0_ap_ready)) then 
    ...
    ap_sig_ready_yuv_filter_yuv_scale_U0_ap_ready_assign_proc : process(yuv_filter_yuv_scale_U0_ap_ready, ap_reg_ready_yuv_filter_yuv_scale_U0_ap_ready)
    begin
        if ((ap_const_logic_0 = ap_reg_ready_yuv_filter_yuv_scale_U0_ap_ready)) then 
    ...
    ap_sig_start_in_yuv_filter_rgb2yuv_U0_ap_start_assign_proc : process(ap_start, ap_reg_ready_yuv_filter_rgb2yuv_U0_ap_ready)
    begin
        if (((ap_const_logic_0 = ap_reg_ready_yuv_filter_rgb2yuv_U0_ap_ready) and (ap_const_logic_1 = ap_start))) then 
    ...
    ap_sig_start_in_yuv_filter_yuv_scale_U0_ap_start_assign_proc : process(ap_start, ap_reg_ready_yuv_filter_yuv_scale_U0_ap_ready)
    begin
        if (((ap_const_logic_1 = ap_start) and (ap_const_logic_0 = ap_reg_ready_yuv_filter_yuv_scale_U0_ap_ready))) then 
    ...
    ap_sig_top_allready_assign_proc : process(ap_sig_ready_yuv_filter_rgb2yuv_U0_ap_ready, ap_sig_ready_yuv_filter_yuv_scale_U0_ap_ready)
    begin
        if (((ap_const_logic_1 = ap_sig_ready_yuv_filter_rgb2yuv_U0_ap_ready) and (ap_const_logic_1 = ap_sig_ready_yuv_filter_yuv_scale_U0_ap_ready))) then 
    ...
    p_scale_channels_ch1_din <= yuv_filter_yuv_scale_U0_out_channels_ch1_din;
    p_scale_channels_ch1_read <= yuv_filter_yuv2rgb_U0_in_channels_ch1_read;
    p_scale_channels_ch1_write <= yuv_filter_yuv_scale_U0_out_channels_ch1_write;
    p_scale_channels_ch2_U_ap_dummy_ce <= ap_const_logic_1;
    p_scale_channels_ch2_din <= yuv_filter_yuv_scale_U0_out_channels_ch2_din;
    p_scale_channels_ch2_read <= yuv_filter_yuv2rgb_U0_in_channels_ch2_read;
    p_scale_channels_ch2_write <= yuv_filter_yuv_scale_U0_out_channels_ch2_write;
    p_scale_channels_ch3_U_ap_dummy_ce <= ap_const_logic_1;
    p_scale_channels_ch3_din <= yuv_filter_yuv_scale_U0_out_channels_ch3_din;
    p_scale_channels_ch3_read <= yuv_filter_yuv2rgb_U0_in_channels_ch3_read;
    p_scale_channels_ch3_write <= yuv_filter_yuv_scale_U0_out_channels_ch3_write;
    p_scale_height_U_ap_dummy_ce <= ap_const_logic_1;
    p_scale_height_din <= yuv_filter_yuv_scale_U0_out_height_din;
    p_scale_height_read <= yuv_filter_yuv2rgb_U0_in_height_read;
    p_scale_height_write <= yuv_filter_yuv_scale_U0_out_height_write;
    p_scale_width_U_ap_dummy_ce <= ap_const_logic_1;
    p_scale_width_din <= yuv_filter_yuv_scale_U0_out_width_din;
    p_scale_width_read <= yuv_filter_yuv2rgb_U0_in_width_read;
    p_scale_width_write <= yuv_filter_yuv_scale_U0_out_width_write;
    p_yuv_channels_ch1_U_ap_dummy_ce <= ap_const_logic_1;
    p_yuv_channels_ch1_din <= yuv_filter_rgb2yuv_U0_out_channels_ch1_din;
    p_yuv_channels_ch1_read <= yuv_filter_yuv_scale_U0_in_channels_ch1_read;
    p_yuv_channels_ch1_write <= yuv_filter_rgb2yuv_U0_out_channels_ch1_write;
    p_yuv_channels_ch2_U_ap_dummy_ce <= ap_const_logic_1;
    p_yuv_channels_ch2_din <= yuv_filter_rgb2yuv_U0_out_channels_ch2_din;
    p_yuv_channels_ch2_read <= yuv_filter_yuv_scale_U0_in_channels_ch2_read;
    p_yuv_channels_ch2_write <= yuv_filter_rgb2yuv_U0_out_channels_ch2_write;
    p_yuv_channels_ch3_U_ap_dummy_ce <= ap_const_logic_1;
    p_yuv_channels_ch3_din <= yuv_filter_rgb2yuv_U0_out_channels_ch3_din;
    p_yuv_channels_ch3_read <= yuv_filter_yuv_scale_U0_in_channels_ch3_read;
    p_yuv_channels_ch3_write <= yuv_filter_rgb2yuv_U0_out_channels_ch3_write;
    p_yuv_height_U_ap_dummy_ce <= ap_const_logic_1;
    p_yuv_height_din <= yuv_filter_rgb2yuv_U0_out_height_din;
    p_yuv_height_read <= yuv_filter_yuv_scale_U0_in_height_read;
    p_yuv_height_write <= yuv_filter_rgb2yuv_U0_out_height_write;
    p_yuv_width_U_ap_dummy_ce <= ap_const_logic_1;
    p_yuv_width_din <= yuv_filter_rgb2yuv_U0_out_width_din;
    p_yuv_width_read <= yuv_filter_yuv_scale_U0_in_width_read;
    p_yuv_width_write <= yuv_filter_rgb2yuv_U0_out_width_write;
    yuv_filter_rgb2yuv_U0_ap_continue <= ap_const_logic_1;
    yuv_filter_rgb2yuv_U0_ap_start <= ap_sig_start_in_yuv_filter_rgb2yuv_U0_ap_start;
    yuv_filter_rgb2yuv_U0_in_channels_ch1_q0 <= in_channels_ch1_q0;
    yuv_filter_rgb2yuv_U0_in_channels_ch2_q0 <= in_channels_ch2_q0;
    yuv_filter_rgb2yuv_U0_in_channels_ch3_q0 <= in_channels_ch3_q0;
    yuv_filter_rgb2yuv_U0_in_height <= in_height;
    yuv_filter_rgb2yuv_U0_in_width <= in_width;
    yuv_filter_rgb2yuv_U0_out_channels_ch1_full_n <= p_yuv_channels_ch1_full_n;
    yuv_filter_rgb2yuv_U0_out_channels_ch2_full_n <= p_yuv_channels_ch2_full_n;
    yuv_filter_rgb2yuv_U0_out_channels_ch3_full_n <= p_yuv_channels_ch3_full_n;
    yuv_filter_rgb2yuv_U0_out_height_full_n <= p_yuv_height_full_n;
    yuv_filter_rgb2yuv_U0_out_width_full_n <= p_yuv_width_full_n;
    yuv_filter_yuv2rgb_U0_ap_continue <= ap_sig_hs_continue;
    yuv_filter_yuv2rgb_U0_in_channels_ch1_dout <= p_scale_channels_ch1_dout;
    yuv_filter_yuv2rgb_U0_in_channels_ch1_empty_n <= p_scale_channels_ch1_empty_n;
    yuv_filter_yuv2rgb_U0_in_channels_ch2_dout <= p_scale_channels_ch2_dout;
    yuv_filter_yuv2rgb_U0_in_channels_ch2_empty_n <= p_scale_channels_ch2_empty_n;
    yuv_filter_yuv2rgb_U0_in_channels_ch3_dout <= p_scale_channels_ch3_dout;
    yuv_filter_yuv2rgb_U0_in_channels_ch3_empty_n <= p_scale_channels_ch3_empty_n;
    yuv_filter_yuv2rgb_U0_in_height_dout <= p_scale_height_dout;
    yuv_filter_yuv2rgb_U0_in_height_empty_n <= p_scale_height_empty_n;
    yuv_filter_yuv2rgb_U0_in_width_dout <= p_scale_width_dout;
    yuv_filter_yuv2rgb_U0_in_width_empty_n <= p_scale_width_empty_n;
    yuv_filter_yuv_scale_U0_U_scale <= U_scale;
    yuv_filter_yuv_scale_U0_V_scale <= V_scale;
    yuv_filter_yuv_scale_U0_Y_scale <= Y_scale;
    yuv_filter_yuv_scale_U0_ap_continue <= ap_const_logic_1;
    yuv_filter_yuv_scale_U0_ap_start <= ap_sig_start_in_yuv_filter_yuv_scale_U0_ap_start;
    yuv_filter_yuv_scale_U0_in_channels_ch1_dout <= p_yuv_channels_ch1_dout;
    yuv_filter_yuv_scale_U0_in_channels_ch1_empty_n <= p_yuv_channels_ch1_empty_n;
    yuv_filter_yuv_scale_U0_in_channels_ch2_dout <= p_yuv_channels_ch2_dout;
    yuv_filter_yuv_scale_U0_in_channels_ch2_empty_n <= p_yuv_channels_ch2_empty_n;
    yuv_filter_yuv_scale_U0_in_channels_ch3_dout <= p_yuv_channels_ch3_dout;
    yuv_filter_yuv_scale_U0_in_channels_ch3_empty_n <= p_yuv_channels_ch3_empty_n;
    yuv_filter_yuv_scale_U0_in_height_dout <= p_yuv_height_dout;
    yuv_filter_yuv_scale_U0_in_height_empty_n <= p_yuv_height_empty_n;
    yuv_filter_yuv_scale_U0_in_width_dout <= p_yuv_width_dout;
    yuv_filter_yuv_scale_U0_in_width_empty_n <= p_yuv_width_empty_n;
    yuv_filter_yuv_scale_U0_out_channels_ch1_full_n <= p_scale_channels_ch1_full_n;
    yuv_filter_yuv_scale_U0_out_channels_ch2_full_n <= p_scale_channels_ch2_full_n;
    yuv_filter_yuv_scale_U0_out_channels_ch3_full_n <= p_scale_channels_ch3_full_n;
    yuv_filter_yuv_scale_U0_out_height_full_n <= p_scale_height_full_n;
    yuv_filter_yuv_scale_U0_out_width_full_n <= p_scale_width_full_n;
end behav;
