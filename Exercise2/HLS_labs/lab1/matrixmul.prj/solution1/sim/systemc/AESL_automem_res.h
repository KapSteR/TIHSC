...
// Port list: { writeonly nouse }


#ifndef _AESL_automem_res_H_
#define _AESL_automem_res_H_
...
struct AESL_automem_res_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(AESL_automem_res_core);
    AESL_automem_res_core(sc_core::sc_module_name) {
...
SC_MODULE( AESL_automem_res )
{
    ...
    SC_CTOR( AESL_automem_res ) {
        meminst = new AESL_automem_res_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    AESL_automem_res_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_AESL_automem_res_H_
