...
#ifndef _AESL_automem_a_H_
#define _AESL_automem_a_H_
...
struct AESL_automem_a_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(AESL_automem_a_core);
    AESL_automem_a_core(sc_core::sc_module_name) {
...
SC_MODULE( AESL_automem_a )
{
    ...
    SC_CTOR( AESL_automem_a ) {
        meminst = new AESL_automem_a_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    AESL_automem_a_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_AESL_automem_a_H_
