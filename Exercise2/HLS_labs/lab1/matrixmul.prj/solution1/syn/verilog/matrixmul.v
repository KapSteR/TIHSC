...
(* CORE_GENERATION_INFO="matrixmul,hls_ip_2014_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.380000,HLS_SYN_LAT=106,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=1,HLS_SYN_FF=62,HLS_SYN_LUT=63}" *)
...
reg  signed [5:0] p_addr7_cast_reg_286;
...
reg   [5:0] tmp_2_trn6_cast_reg_300;
wire   [0:0] exitcond1_fu_160_p2;
reg   [3:0] res_addr_reg_305;
wire   [1:0] k_1_fu_196_p2;
reg   [1:0] k_1_reg_313;
reg    ap_sig_cseq_ST_st4_fsm_3;
reg    ap_sig_bdd_86;
wire   [0:0] exitcond_fu_190_p2;
reg   [7:0] a_load_reg_328;
reg    ap_sig_cseq_ST_st5_fsm_4;
reg    ap_sig_bdd_101;
reg   [7:0] b_load_reg_333;
wire  signed [15:0] tmp_8_fu_272_p2;
...
wire  signed [7:0] tmp_7_fu_266_p0;
wire  signed [7:0] tmp_7_fu_266_p1;
wire  signed [15:0] tmp_7_fu_266_p2;
reg   [5:0] ap_NS_fsm;
...
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2) & (ap_const_lv1_0 == exitcond1_fu_160_p2))) begin
        res_addr_reg_305 <= tmp_2_fu_185_p1;
...
assign p_addr1_fu_210_p2 = ($signed(p_addr7_cast_reg_286) + $signed(tmp_4_trn_cast1_fu_202_p1));
...
assign p_addr4_fu_246_p2 = ($signed(p_addr3_cast_fu_242_p1) + $signed(tmp_2_trn6_cast_reg_300));
...
assign p_addr8_fu_176_p2 = ($signed(p_addr7_cast_reg_286) + $signed(tmp_2_trn6_cast_fu_172_p1));
assign p_shl9_cast_fu_232_p1 = tmp_9_fu_224_p3;
assign p_shl_cast_fu_146_p1 = tmp_fu_138_p3;
assign res_address0 = res_addr_reg_305;
...
assign tmp_7_fu_266_p0 = b_load_reg_333;
assign tmp_7_fu_266_p1 = a_load_reg_328;
assign tmp_7_fu_266_p2 = ($signed(tmp_7_fu_266_p0) * $signed(tmp_7_fu_266_p1));
assign tmp_8_fu_272_p2 = ($signed(res_load_reg_97) + $signed(tmp_7_fu_266_p2));
...
always @ (posedge ap_clk)
begin
    tmp_2_trn6_cast_reg_300[5:2] <= 4'b0000;
end
