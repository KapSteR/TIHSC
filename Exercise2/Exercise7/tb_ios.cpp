...
int sc_main (int argc , char *argv[])
{
	...
	//U_iosc.second(s_second);

	//U_tb_timerModule.clk(s_clk);
	//U_tb_timerModule.reset(s_reset);
	//U_tb_timerModule.second(s_second);
